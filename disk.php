        ...
        <div class="jumbotron">
            <div class="row">
                <?php
                        ...
                        echo '<h2> Logs >'.$machineName.'>'.$datetimeLog.'> Disk </h2>';
                    ...
                    <tbody>
                        <?php
                            ...
                            if (null == $id) {
                                ...
                                $sql = 'select * from disk_usage where ref_time_id = :ref_time_id';                                
                                ...
                                foreach($all_records as $row)
                                {
                                    ...
                                    echo '<td>'. $row['size'] . '</td>';
                                    echo '<td>'. $row['used'] . '</td>';
                                    echo '<td>'. $row['mounted_on'] . '</td>';
                                    echo '<td>'. $row['available'] . '</td>';
                                    echo '<td>'. $row['use_percent'] . '</td>';                                    
                                }
